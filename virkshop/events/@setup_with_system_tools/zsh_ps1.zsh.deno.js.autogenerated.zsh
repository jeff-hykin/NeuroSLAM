# this was autogenerated by: "virkshop/plugins/zsh.deno.js"
;
...
'/Users/jeffhykin/.deno/1.41.3/bin/deno' 'eval' '--no-lock' '--no-config' '-q' '
                                                    ...
                                                    const eventName = "@setup_with_system_tools/zsh_ps1"
...
AKA the @setup_with_system_tools/zsh_ps1 isn'"'"'t allowed to return an object.`)
                                                        Deno.exit(1)
                                                    }
